  ...
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      <div className="flex justify-between items-center">
        <h1
          className="text-content md:text-lg lg:text-xl cursor-pointer"
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex items-center">
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M19.14,12.94a7.15,7.15,0,0,0,.05-.94,7.15,7.15,0,0,0-.05-.94l2.11-1.65a.5.5,0,0,0,.12-.63l-2-3.46a.5.5,0,0,0-.6-.22l-2.49,1a7.12,7.12,0,0,0-1.63-.94l-.38-2.65A.5.5,0,0,0,13.64,3H10.36a.5.5,0,0,0-.49.42L9.49,6.07a7.12,7.12,0,0,0-1.63.94l-2.49-1a.5.5,0,0,0-.6.22l-2,3.46a.5.5,0,0,0,.12.63L4.86,11.06a7.15,7.15,0,0,0-.05.94,7.15,7.15,0,0,0,.05.94L2.75,14.59a.5.5,0,0,0-.12.63l2,3.46a.5.5,0,0,0,.6.22l2.49-1a7.12,7.12,0,0,0,1.63.94l.38,2.65a.5.5,0,0,0,.49.42h3.28a.5.5,0,0,0,.49-.42l.38-2.65a7.12,7.12,0,0,0,1.63-.94l2.49,1a.5.5,0,0,0,.6-.22l2-3.46a.5.5,0,0,0-.12-.63ZM12,15.5A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" />
            </svg>
            <p className="text-content text-xs md:text-sm font-light pl-1">{technology}</p>
          </div>
        </div>
