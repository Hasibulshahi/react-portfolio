  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <nav className="md:flex justify-between">
        <ul className="dark:text-light-content font-medium flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li className="pb-1 md:pb-0">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-blue-500 font-bold" // Highlight active link
                  : "hover:text-blue-500"
              }
            >
              Home
